...
output_folder = '/users/nivl/data/autoencoder/classifier/fixed/{}{}/{}{}{}_{}_hsp{}_pct{}_{}_hsp'.format(month, day, hour, minute, sec, task, hsp_str, pct_str, pretrained_model)
...
if pretrained_model == 'ae':
    ...
    mat = sio.loadmat('/users/nivl/data/autoencoder/dbn/hsp_{}/1_15epoc.mat'.format(hsp_str))
