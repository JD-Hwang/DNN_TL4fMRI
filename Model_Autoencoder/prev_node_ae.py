...
from data_utils import collect_sbj_data
...
pct_str = 'none' if not denoising else str(int(pct * 100))
output_folder = '/users/nivl/data/autoencoder/hsp/{}{}/hsp{}_{}pct_{}_prev'.format(day, month, hsp_str, pct_str, noise_type)
...
noisy_samples = get_noisy_data(samples.clone(), pct)
